...
! function(f, b) {
    ...
    function i() { var o = f.innerWidth > 750 ? 750 : f.innerWidth; var p = m !== 0 ? Math.min(o / n, f.innerHeight / m) : o / n; return parseInt(p * 10000 * a) / 10000 }! function() {
...
}(window, { designWidth: 750, designFontSize: 100, });